...
function Footer() {
  return (
    <footer className="bg-gray-100 border-t border-gray-300 py-10 text-sm">
      <div className="max-w-5xl mx-auto pb-8 mb-6 border-b border-gray-300 px-4 lg:px-0">
        <div className="flex flex-wrap items-start justify-start">
          <div className="lg:w-1/4 w-full lg:mb-0 mb-6">
            <h5 className="font-semibold text-gray-700 mb-2">Airbnb</h5>
          ...
          <div className="lg:w-1/4 w-full lg:mb-0 mb-6">
            <h5 className="font-semibold text-gray-700 mb-2">Discover</h5>
            <ul className="leading-loose">
              <li>
                <a
                  className="text-gray-600 hover:underline font-semibold"
              ...
              <li className="flex">
                ...
                <span className="bg-cyan px-1 inline-flex items-center h-5 text-white rounded ml-1 mt-1 inline-block bg-black text-xs">
                  New
                </span>
              </li>
              <li>
          ...
          <div className="lg:w-1/4 w-full lg:mb-0 mb-6">
            <h5 className="font-semibold text-gray-700 mb-2">Hosting</h5>
            <ul className="leading-loose">
              <li>
                <a
                  className="text-gray-600 hover:underline font-semibold"
      ...
      <div className="max-w-5xl mx-auto flex items-center px-4 lg:px-0">
        <svg
